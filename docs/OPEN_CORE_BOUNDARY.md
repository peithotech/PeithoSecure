...
### 🖥️ The UI & Observability Boundary
...
### 🗺️ The 3-Tier Capability Matrix
...
| **Central Audit Aggregation** | ⚠️ Local text logs | ✅ Team audit trail | ✅ Cryptographically signed immutable journal |
| **SIEM Integrations (Splunk, Datadog)**| ❌ | ⚠️ Webhook export | ✅ Direct streaming connectors |
| **Global Revocation Distribution** | ⚠️ Local in-memory | ⚠️ Out-of-band sync | ✅ Multi-region gossip with SLA bounds |
| **Multi-Region HA Control Plane** | ❌ Local | ⚠️ Standby failover | ✅ Multi-region Raft cluster |
